...
tai <- c("aku/sudah/ngantuk", "aku sudah ngantuk", "aku sudah ngantuk", "aku sudah ngantuk", "aku sudah ngantuk")
...
berita_htc <- data.frame(Website, tai)
...
library(kableExtra)
berita_htc %>% 
  kable(caption = "Beberapa artikel terkait konflik mansia dan harimau (KMH) di Aceh",
      format = "html") %>% 
