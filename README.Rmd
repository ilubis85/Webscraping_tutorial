...
```{r, out.width='80%', fig.align='center', fig.cap='Kata dengan frequensi paling banyak', echo=FALSE, warning=TRUE}
# Visualisasi data
...
```
### b. Word cloud
Anda juga dapat membuat word cloud atau awan kata untuk memvisualisasikan kata-kata dan frekuensinya.
```{r, out.width='60%', fig.align='center', fig.cap='Worcloud', echo=FALSE, warning=FALSE, message=FALSE}
...
```
### c. Analisis sentimen
Contoh analisis selanjutnya adalah analisis sentimen yang bertujuan untuk mengidentifikasi sentimen positif, negatif, atau netral yang terungkap dalam data yang telah di-scrape.
```{r}
# Memuat library yang diperlukan
library(tidytext)
library(sentimentr)
